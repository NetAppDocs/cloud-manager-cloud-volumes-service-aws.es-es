$(document).ready(function () {
  try {
    ...
    let baseUrlSection = "/es-es/cloud-manager-cloud-volumes-service-aws/pdfs/";
    ...
    zipFilename = zipFilename !== ''?zipFilename:"cloud-manager-cloud-volumes-service-aws.es-es.zip";
